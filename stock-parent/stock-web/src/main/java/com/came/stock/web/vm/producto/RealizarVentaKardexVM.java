...
public class RealizarVentaKardexVM extends BasicStructure {
	private static final long serialVersionUID = 3098239433101641553L;
	@Wire("#realizarVentaKardexVMModalDialog")
	private Window realizarVentaKardexVMModalDialog;
	...
	public void transferProduct() {
		if(cantidad != null){
			...
			if(esNumerico){
				realizarVentaKardexVMModalDialog.detach();
	...
	public void closeDialog() {
		if (realizarVentaKardexVMModalDialog != null)
			realizarVentaKardexVMModalDialog.detach();
	}
