...
@Entity
@Table
public class ConffyaProg {
	private Long idConffyaProg;
	...
	@Column
	public Long getIdConffyaProg() {
		return this.idConffyaProg;
	}

	public void setIdConffyaProg(Long idConffyaProg) {
		this.idConffyaProg = idConffyaProg;
	}
