...
@Entity
@Table
public class ConffyaPy {
	private Long idConffyaPy;
	...
	@Column
	public Long getIdConffyaPy() {
		return this.idConffyaPy;
	}

	public void setIdConffyaPy(Long idConffyaPy) {
		this.idConffyaPy = idConffyaPy;
	}
