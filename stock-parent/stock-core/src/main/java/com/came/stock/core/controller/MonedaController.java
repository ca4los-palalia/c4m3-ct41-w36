...
@RestController
public class MonedaController extends ServicesCore {

	@PostMapping({ ConstPath.MAP_MONEDA_SAVE })
	...
	@PostMapping({ ConstPath.MAP_MONEDA_DELETE })
	@Produces("application/json")
...
//itemReturn.setSingle(response);
	...
	@PostMapping({ ConstPath.MAP_MONEDA_BY_ID })
	@Produces("application/json")
	...
	@PostMapping({ ConstPath.MAP_MONEDA_ALL })
	@Produces("application/json")
