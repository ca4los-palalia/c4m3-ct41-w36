...
@RestController
public class PosicionController extends ServicesCore {

	@PostMapping({ ConstPath.MAP_POSICION_SAVE })
	...
	@PostMapping({ ConstPath.MAP_POSICION_DELETE })
	@Produces("application/json")
	...
	@PostMapping({ ConstPath.MAP_POSICION_BY_ID })
	@Produces("application/json")
...
//		tranferParam.put("organizacion", organizacion);
	...
	@PostMapping({ ConstPath.MAP_POSICION_ALL })
	@Produces("application/json")
